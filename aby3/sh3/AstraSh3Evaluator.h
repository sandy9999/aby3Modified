...
namespace aby3
{
    ...
    Sh3Task astra_asyncMul_preprocess_distributor(Sh3Task dep, const si64Matrix& left, const si64Matrix& right, si64& product_share);

    Sh3Task astra_asyncMul_preprocess_evaluator(Sh3Task dep, i64& product_alpha_share, i64& alpha_left_alpha_right_share);

    Sh3Task astra_asyncMul_online(Sh3Task dep, const si64Matrix& left , const si64Matrix& right, si64& product_share, i64& alpha_left_alpha_right_share, i64& product_alpha_share);
    ...
    template<Decimal D>
		...
		Sh3Task astra_asyncMul_preprocess_evaluator(
			Sh3Task dep,
			const f64<D>& product_alpha_share,
			const f64<D>& alpha_left_alpha_right_share);
		...
		Sh3Task astra_asyncMul_online(
			...
			const sf64Matrix<D>& right,
      sf64<D>& product_share,
      f64<D>& alpha_left_alpha_right_share,
      f64<D>& product_alpha_share);
    ...
    template<Decimal D>
      ...
      auto& product_share_cast = (si64&)product_share;
      ...
      auto& product_alpha_share_cast = (i64&)product_alpha_share;
      auto& alpha_left_alpha_right_share_cast = (i64&)alpha_left_alpha_right_share;
